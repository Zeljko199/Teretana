                    ...
                    <div class="card">
                        ...
                        <h4 class="card-title mb-4">Detalji o korisniku</h4>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($editData->profile_image))? url('image/admin_images/'.$editData->profile_image):url('image/admin_images/avatar.jpg') }}" alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
