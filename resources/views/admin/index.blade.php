        ...
        <div class="container-fluid">
            ...
            <div class="row margin-top-10">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    @include('admin.dashboardIndex.totalMembers')
                </div>
                <!-- Total Trainers -->
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    @include('admin.dashboardIndex.totalTrainers')
                </div>
                <!-- Registrations This Weeks -->
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    <!---   'dashboard._index.registeredThisMonth'  -->
                </div>
                <!-- Inactive Members -->
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    <!---   'dashboard._index.outstandingPayments')--->
                </div>
                <!-- Collection -->
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    <!---   'dashboard._index.collection'--->
                </div>
            </div>
            <!-- end page title -->
