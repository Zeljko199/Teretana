    ...
    <div class="container-fluid p-0">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="text-muted text-center font-size-18"><b>Resetovanje šifre</b></h4>

                <div class="p-3">
                    <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">

                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            Unesite svoj <strong>E-mail</strong> i pratite dalje instrukcije!
                        ...
                        <div class="form-group pb-2 text-center row mt-3">
                            <div class="col-12">
                                <button class="btn btn-info w-100 waves-effect waves-light" type="submit">Pošalji Email</button>
                            </div>
                        </div>
                    </form>
                </div>
